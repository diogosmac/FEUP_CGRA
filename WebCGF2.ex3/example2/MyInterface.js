...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // a folder for grouping parameters for displaying the tangram
        var f3 = this.gui.addFolder('Tangram Options');
        f3.add(this.scene.tangram, 'displayYellow').name('Display Yellow');
        f3.add(this.scene.tangram, 'displayPink').name('Display Pink');
        f3.add(this.scene.tangram, 'displayBlue').name('Display Blue');
        f3.add(this.scene.tangram, 'displayOrange').name('Display Orange');
        f3.add(this.scene.tangram, 'displayRed').name('Display Red');
        f3.add(this.scene.tangram, 'displayPurple').name('Display Purple');
        f3.add(this.scene.tangram, 'displayGreen').name('Display Green');


        this.gui.add(this.scene, 'scaleFactor', 0.1, 10.0).name('Scale');
        this.gui.add(this.scene, 'ambientLightIntensity', 0.01, 1.0).name('Ambient Light').onChange(this.scene.updateGlobalAmbientLight.bind(this.scene));
