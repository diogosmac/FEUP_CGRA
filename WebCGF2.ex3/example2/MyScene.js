...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Wood Material (low specular component)
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0.51, 0.33, 0.01, 1.0);
        this.material4.setDiffuse(0.51, 0.33, 0.01, 1.0);
        this.material4.setSpecular(0.25, 0.16, 0.0, 1.0);
